  ...
  return (
    <section className="py-12 w-full flex flex-col md:flex-row" id="productos">
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="flex flex-col items-start sm:w-full md:w-1/3 lg:w-1/3">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center bg-black p-6 w-full sm:w-2/3 md:w-2/3 lg:w-2/3">
          <div className="w-full sm:w-1/2 lg:mr-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-white">
              NUESTROS <span className="text-red-700">SERVICIOS</span>
            </h2>
            <p className="mb-4 text-white text-justify text-base sm:text-lg md:text-2xl">
            ...
            <p className="text-white text-justify text-base sm:text-lg md:text-2xl mt-10">
