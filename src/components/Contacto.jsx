    ...
    <section className="bg-black  w-full flex justify-between" id="contacto">
      <div className="ml-10 flex justify-center items-center">
        ...
        <p className="text-white font-bold text-2xl flex flex-col items-start ml-2 mt-8">
          SOLDIMAT <span className="text-white font-normal">MATAFUEGOS</span>
        </p>
      </div>
      ...
      <div className="flex flex-col items-start gap-y-3">
        ...
        <div className="flex flex-col items-start gap-y-3">
  <h3 className="text-white mt-2 font-bold">HORARIO DE ATENCIÓN</h3>
  <div className="flex">
    <div className="flex items-center">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"  // Aumenta el tamaño a 24 para que coincida con el tamaño del ícono de Instagram
        height="25" // Aumenta el tamaño a 24 para que coincida con el tamaño del ícono de Instagram
        fill="currentColor"
        stroke="currentColor"  // Añadir la propiedad stroke para que el color de borde coincida con el color del relleno
        strokeWidth="0.5"  // Ajustar el grosor de la línea para hacer el ícono más grueso
      ...
      <div className="relative p-6 rounded-md shadow-md mr-36">
        ...
        <div className="relative z-10 text-start">
          ...
          <p className="text-white mb-2 flex ">
            ...
            123 Calle Principal, Villa María, Cordoba
          </p>
          <p className="text-white mb-2 flex">
            <strong>
              <svg
